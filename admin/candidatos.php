    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="col-md-2 text-right">
                <h1><a href="cadastrar_candidato.php" class="btn btn-primary"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Novo Candidato</a></h1>
            </div>
            <br/>
                ...
                if ($result = $link->query($query_list)) {
                    ...
                    while ($row = $result->fetch_row()) {
                        ...
                        <tr>
                            ...
                            <td><?= $row[12] ?></td>
                            <td>
                                <a href="editar_candidato.php?id=<?= $row[0] ?>"
                                ...
                                <a onclick="return confirm('Deseja realmente excluir este curso?')"
                                   href="excluir_candidato.php?id=<?= $row[0] ?>"
