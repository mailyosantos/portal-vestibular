    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="col-md-2 text-right">
                <h1><a href="curso/cadastrar_curso.php" class="btn btn-primary"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Novo Curso</a></h1>
            </div>
            <br/>
                ...
                if ($result = $link->query($query_list)) {
                    ...
                    while ($row = $result->fetch_row()) {
                        ...
                        <tr>
                            ...
                            <td><?= $row[6] ?></td>
                            <td>
                                <a href="curso/editar_curso.php?id=<?= $row[0] ?>"
                                ...
                                <a onclick="return confirm('Deseja realmente excluir este curso?')"
                                   href="curso/excluir_curso.php?id=<?= $row[0] ?>"
